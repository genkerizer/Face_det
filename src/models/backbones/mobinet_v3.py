...
class MobileNetV3(nn.Module):
    def __init__(self, mode='small', width_mult=1.0, **kwargs):
        ...
        if mode == 'large':
            ...
            last_conv = make_divisible(256 * width_mult)
...
if __name__ == '__main__':
    import time
    net = MobileNetV3(mode='small', width_mult=1.0)
